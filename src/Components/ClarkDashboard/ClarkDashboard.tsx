...
interface ClarkDashboardProps {
    setIsAuthenticated: (auth: boolean) => void;
}

const ClarkDashboard: React.FC<ClarkDashboardProps> = ({ setIsAuthenticated }) => {
    ...
    // Get clark data from sessionStorage
    const clarkName = sessionStorage.getItem("loggedInUser") || "Clark User";
    const clarkEmail = sessionStorage.getItem("User_Email") || "No email available";
    const clarkId = sessionStorage.getItem("User_id") || "No ID available";
                                                ...
                                                <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                                                    ...
                                                    >
                                                        <Typography variant="h4" sx={{ color: 'white' }}>
                                                            {clarkName.charAt(0).toUpperCase()}
                                                        </Typography>
                                                    </Avatar>
                                                    <Box>
