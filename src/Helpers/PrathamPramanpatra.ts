...
const TEXT_SIZE = 16;
const SUB_Heading = 12;
export const prathamPramanpatra = (certificateData: any) => {
    ...
    sections: [
      {
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "(शासन निर्णय , सामान्य प्रशासन विभाग क्रमांक एईएम-108035 दि. /16 अ,दि.21 जानेवारी 1980) ",
                size: TEXT_SIZE,
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({ text: "प्रकरण क्रमांक :", size: HEADING_SIZE }),
              new TextRun({ text: ` ${certificateData.pramanpatra_number || "---"}`, size: HEADING_SIZE, bold: true }),
            ],
            alignment: AlignmentType.RIGHT,
          }),
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: `(हे उपरोक्त परिच्छेद 1 व 2) मधील प्रकल्पग्रस्त व्यक्तीच्या कुटुंबातील आणि तिच्यावर अवलंबुन असणारी व्यक्ती असुन त्याचे प्रकल्पग्रस्त व्यक्तीशी नाते `,
                size: TEXT_SIZE,
              }),
              new TextRun({
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `(सदर प्रमाणपत्र भुसंपादन अधिकारी यांचे प्रमाणपत्र, कार्यकारी अभियंता यांचे प्रमाणपत्र, बाधिताचे प्रतिज्ञापत्र व अर्ज T.C.या आधारे देण्यात येत आहे.)`,
                size: SUB_Heading,
              }),
            ],
            alignment: AlignmentType.JUSTIFIED,
