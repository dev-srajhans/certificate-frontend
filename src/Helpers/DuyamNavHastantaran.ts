...
const TEXT_SIZE = 16;
export const DuyamNavHastantaran = (certificateData: any, junaDharak: string | null) => {
    ...
    sections: [
      {
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({ text: "प्रकल्पबाधित व नामनिर्देशित व्यक्तीच्या सहमतीने मूळ प्रमाणपत्रातील", size: TEXT_SIZE }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `${junaDharak || "________"}) यांचे नावाने दि : ${new Date(certificateData.issue_dt).toLocaleDateString('en-GB') || "DD/MM/YYYY"} ला पहिल्यांदा हस्तांतरित करण्यात आलेला होता.`,
                bold: true, size: TEXT_SIZE
              }),
            ],
            alignment: AlignmentType.LEFT,
          }),
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `परंतु ${junaDharak || "________"}  यांना नोकरीचा लाभ न झाल्याने.`,
                bold: true, size: TEXT_SIZE
              }),
            ],
            alignment: AlignmentType.LEFT,
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `परंतु ${junaDharak || "________"}  यांचे नाव रद्द करुन `,
                size: TEXT_SIZE
              }),
              new TextRun({
                text: ` ${pramanpatradharakMember.name || "________"} (${pramanpatradharakMember.relation || "________"}) यांचे नाव दुस-यांदा हस्तांतरण करण्यात आले.`,
                bold: true, size: TEXT_SIZE
              }),
            ],
            alignment: AlignmentType.LEFT,
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `${certificateData.hastantaran_reason || "________"}`,
                size: TEXT_SIZE
              }),
            ],
            alignment: AlignmentType.LEFT,
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `दि : ${new Date().toLocaleDateString('en-GB') || "DD/MM/YYYY"}  `, size: TEXT_SIZE
              }),
            ],
            alignment: AlignmentType.LEFT,
          }),
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "उपजिल्हाधिकारी (पुनर्वसन)", bold: true, size: HEADING_SIZE
              }),
            ],
            alignment: AlignmentType.LEFT,
          }),
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "जिल्हाधिकारी कार्यालय, अमरावती", bold: true, size: HEADING_SIZE
              }),
            ],
            alignment: AlignmentType.LEFT,
          }),
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: `येथिल शेत सर्व्हे क्रमांक / गट क्रमांक ${certificateData.shet_jamin_serve_gut || "_______"} मधील क्षेत्र ${certificateData.shet_jamin_shetra || "_______"}  हे. आर क्षेत्र ${certificateData.prakalpa_nav || "_______"}  प्रकल्पाच्या उजव्या कालजव्याकरिता कामाकरिता संपादन केलेले असल्यामुळे ते प्रकल्पग्रस्त व्यक्ती आहे./ आहेत.`,
                size: TEXT_SIZE,
              }),
            ],
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: ` येथिल घर क्रमांक ${certificateData.budit_malmata_ghar_number || "_______"}  ${certificateData.prakalpa_nav || "_______"} प्रकल्पासाठी संपादन केलेली असल्यामुळे ते प्रकल्पग्रस्त व्यक्ती आहे./आहेत. `,
                size: TEXT_SIZE,
              }),
            ],
            alignment: AlignmentType.JUSTIFIED,
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: ` [${junaDharak || "________"}] `,
                bold: true,
                strike: true,
                size: TEXT_SIZE,
              }),
              new TextRun({
                text: ` ${pramanpatradharakMember.name || "________"} (${pramanpatradharakMember.relation || "________"}) यांचे नाव दि: ${new Date().toLocaleDateString('en-GB') || "DD/MM/YYYY"} ला दुस-यांदा हस्तांतरण करुन दिले.`,
                bold: true, size: TEXT_SIZE
              }),


              new TextRun({
                text: ` (हे उपरोक्त परिच्छेद 2) मधील  प्रकल्पग्रस्त  व्यक्तीच्या कुटुंबातील आणि तिच्यावर अवलंबुन असणारी व्यक्ती असुन त्याचे प्रकल्पग्रस्त व्यक्तीशी नाते `, size: TEXT_SIZE
              }),
              new TextRun({
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `4.शासनाच्या पुनर्वसन योजनेअंतर्गत सदर प्रकल्पग्रस्ता व्यक्तीला किंवा तिच्या कुटुंबातील आणि तिच्यावर अवलंबुन असणा-या उपरोक्त एकाच व्यक्तीला नोकरी मिळणा-या संदर्भात सदर दाखला परिणामकारक राहिल. वरीलप्रमाणे संबंधित व्यक्तीला नोकरी मिळाल्यावर या दाखल्याचे परिणामकारकता रद्द होईल.`,
                size: TEXT_SIZE,
              }),
            ],
            alignment: AlignmentType.JUSTIFIED,
