...
const TEXT_SIZE = 16;
export const NavHastantaran = (certificateData: any, junaDharak: string | null) => {
    ...
    sections: [
      {
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({ text: "नामनिर्देशितास नोकरी चा लाभ न झान्याने", size: TEXT_SIZE }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({ text: "प्रकल्पबाधिताच्या वारसाच्या सहमतीने मूळ प्रमाणपत्रातील\n", size: TEXT_SIZE }),
            ],
            alignment: AlignmentType.LEFT,
          }),
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `${junaDharak || "________"}) यांचे रद्द करुन \n`,
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `${pramanpatradharakMember.name || "________"} (${pramanpatradharakMember.relation || "________"}) यांचे नावे पहिल्यांदा  \n`,
                bold: true, size: TEXT_SIZE
              }),
            ],
            alignment: AlignmentType.LEFT,
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `दि : ${new Date().toLocaleDateString('en-GB') || "DD/MM/YYYY"} हस्तांतरण करुन दिले.\n`, size: TEXT_SIZE
              }),
            ],
            alignment: AlignmentType.LEFT,
          }),
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "उपजिल्हाधिकारी (पुनर्वसन) जिल्हाधिकारी कार्यालय, अमरावती", bold: true, size: HEADING_SIZE
              }),
            ],
            alignment: AlignmentType.LEFT,
          }),
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `${pramanpatradharakMember.name || "________"} (${pramanpatradharakMember.relation || "________"}) यांचे नावे\n`,
                bold: true, size: TEXT_SIZE
              }),
            ],
            alignment: AlignmentType.RIGHT,
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `दि : ${new Date(certificateData.issue_dt).toLocaleDateString('en-GB') || "DD/MM/YYYY"} ला पहिल्यांदा हस्तांतरण करुन दिले.\n`, size: TEXT_SIZE
              }),
            ],
            alignment: AlignmentType.RIGHT,
          }),
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: ` ${pramanpatradharakMember.name || "________"} (${pramanpatradharakMember.relation || "________"})`,
                bold: true, size: TEXT_SIZE
              }),
              new TextRun({
